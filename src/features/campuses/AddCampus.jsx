...
const AddCampus = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <TextField margin="normal" required label="Address" value={address} onChange={(e) => setAddress(e.target.value)} />
      <TextField 
        margin="normal" 
        required  
        label="Description" 
        ...
        rows={4}
      />
      <Button sx={{mx: 'auto', mt:2 }} variant="contained" type="submit">Add Campus</Button>
      </Box>
    </form>
  );
